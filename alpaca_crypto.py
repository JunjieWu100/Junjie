...
def get_realtime_data():
    try:
        # Fetch the most recent 10-minute bars for BTCUSD (use get_crypto_bars for crypto)
        barset = api.get_crypto_bars('BTCUSD', tradeapi.TimeFrame.Minute, limit=10).df  # Fetch 10 bars
        barset = barset[barset['exchange'] == 'CBSE']  # Filter for Coinbase data
